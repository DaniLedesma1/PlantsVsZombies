...
public class PlantList {
	...
	public void damagePlant(int x, int y, int damage) {
		...
		if(pos != -1) {
			...
			if(dead) {
				for(int i = pos; i < this.plantsNumber - 1; i++){ //Aqui ponia pos y no i en la condicion
	...
	//Busca una planta en el array dadas sus coordenadas, devuelve su posición
	...
	//------------------------AUXILIAR----------------------------
	//Devuelve el numero de PeaShooters de la lista
